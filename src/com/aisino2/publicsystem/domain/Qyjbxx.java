...
public class Qyjbxx extends BaseObject {
	...
	private Date xfshyjsfzrq;//消防审核意见书发证日期
	
	private String gdjycscqbh;//固定经营场所产权编号
	private String gdjycssyqbh;//固定经营场所使用权编号
	
	private String exportFlag;// excel导出标识；0：只查询 1：查询且导出
	...
	/**
	 * @param frxbdm the frxbdm to set
	 */
	...
	/**
	 * @param jyfzrxb the jyfzrxb to set
	 */
	...
	/**
	 * @return the jyfzrxbdm 经营负责人性别代码
	 */
	...
	/**
	 * @param jyfzrxbdm the jyfzrxbdm to set
	 */
	...
	/**
	 * @return the jyxkzfzrq 经营许可证发证日期
	 */
	...
	/**
	 * @param jyxkzfzrq the jyxkzfzrq to set
	 */
	...
	/**
	 * @return the jyxkzyxqz 经营许可证有效期至
	 */
	...
	/**
	 * @param jyxkzyxqz the jyxkzyxqz to set
	 */
	...
	/**
	 * @return the thxkzfzrq 特行许可证发证日期
	 */
	...
	/**
	 * @param thxkzfzrq the thxkzfzrq to set
	 */
	...
	/**
	 * @return the thxkzyxqz 特行许可证有效期至
	 */
	...
	/**
	 * @param thxkzyxqz the thxkzyxqz to set
	 */
	...
	/**
	 * @param yyzzfzrq the yyzzfzrq to set
	 */
	...
	/**
	 * @param yyzzyxqz the yyzzyxqz to set
	 */
	...
	/**
	 * @return the xfshyjsbh 消防审核意见书编号
	 */
	...
	/**
	 * @param xfshyjsbh the xfshyjsbh to set
	 */
	...
	/**
	 * @return the xfshyjsfzjg 消防审核意见书发证机关
	 */
	...
	/**
	 * @param xfshyjsfzjg the xfshyjsfzjg to set
	 */
	...
	/**
	 * @return the xfshyjsfzjgdm 消防审核意见书发证机关代码
	 */
	...
	/**
	 * @param xfshyjsfzjgdm the xfshyjsfzjgdm to set
	 */
	...
	/**
	 * @return the xfshyjsfzrq 消防审核意见书发证日期
	 */
	...
	/**
	 * @param xfshyjsfzrq the xfshyjsfzrq to set
	 */
	public void setXfshyjsfzrq(Date xfshyjsfzrq) {
		this.xfshyjsfzrq = xfshyjsfzrq;
	}

	public List getLZzclxxList() {
		return lZzclxxList;
	}

	public void setLZzclxxList(List zzclxxList) {
		lZzclxxList = zzclxxList;
	}
