...
public class Qysctj extends BaseObject {
	...
	private String sksjString;//刷卡日期格式化
	...
	public String getSksjString() {
		return sksjString;
	}

	public void setSksjString(String sksjString) {
		this.sksjString = sksjString;
	}
