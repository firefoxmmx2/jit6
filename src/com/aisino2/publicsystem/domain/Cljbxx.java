...
public class Cljbxx extends BaseObject {

	/** @param 车辆基本信息(t_cljbxx) */
	
	/** @ --车辆基本信息ID--cljbxxid--Integer--10-- */
	private Integer cljbxx_lsid;
...
/** 车辆是否比对*/
	private String clsfbd;
	
	public String getClsfbd() {
	return clsfbd;
}

public void setClsfbd(String clsfbd) {
	this.clsfbd = clsfbd;
}
	...
	public Integer getCljbxx_lsid() {
		return cljbxx_lsid;
	}

	public void setCljbxx_lsid(Integer cljbxx_lsid) {
		this.cljbxx_lsid = cljbxx_lsid;
	}
